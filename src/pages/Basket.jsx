        ...
        <Table >
                ...
                {basket.map(el => <tr key={el.id}>
                    ...
                    <td className="align-middle">
                        <ButtonGroup>
                            <Button 
                                ...
                                onClick={() => dec(el.id)}
                            >-</Button>
                            <Button variant="ligth" disabled>{el.cnt}</Button>
                    ...
                    <td className="align-middle">
                        ...
                        ? <>
                            ...
                            <del className="ms-2 small text-secondaryd-inline-block">{el.price * el.cnt} ₽</del>
                        </> 
            ...
            <tfoot>
                <tr>
                    ...
                    <td className="fs-5 fv-bold">{sumDiscount === sum 
                        ? <span>{sum} ₽</span>
                        : <>
                            <span className="text-danger">{Math.ceil(sumDiscount)} ₽</span>
                            <del className="ms-2 small text-secondaryd-inline-block">{sum} ₽</del>
                        </>
                        }</td>
                </tr>
            </tfoot>
